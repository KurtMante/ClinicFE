  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ margin: 0, fontWeight: 700, color: '#d32f2f', letterSpacing: 1, fontSize: 20 }}>
      ...
      >
        <h3 style={{ margin: '0 0 8px 0', color: '#d32f2f', fontWeight: 600, fontSize: 16 }}>Request Emergency Reschedule</h3>
        ...
        {message && (
          <div style={{
            marginTop: 6,
            color: message.includes('submitted') ? '#388e3c' : '#d32f2f',
            fontWeight: 500,
            fontSize: 13
          }}>
            {message}
      ...
      <div style={{
        ...
        <h3 style={{ margin: '0 0 8px 0', color: '#d32f2f', fontWeight: 600, fontSize: 15 }}>All Emergency Reschedules</h3>
